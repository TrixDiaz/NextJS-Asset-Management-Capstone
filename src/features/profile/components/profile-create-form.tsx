      ...
      <div className='mt-8 pt-5'>
        <div className='flex justify-between'>
          <button
            ...
            className='bg-primary/10 text-primary ring-primary/30 hover:bg-primary/5 rounded px-2 py-1 text-sm font-semibold shadow-xs ring-1 ring-inset disabled:cursor-not-allowed disabled:opacity-50'
          >
            <svg
