...
const assetSchema = z.object({
    ...
    assetType: z.enum([ 'COMPUTER', 'PRINTER', 'PROJECTOR', 'NETWORK_EQUIPMENT', 'OTHER' ]),
    systemUnit: z.string().optional(),
    monitor: z.string().optional(),
    ups: z.string().optional(),
    status: z.enum([ 'WORKING', 'NEEDS_REPAIR', 'OUT_OF_SERVICE', 'UNDER_MAINTENANCE' ]).default('WORKING'),
            ...
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>A unique identifier for this asset</FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
                            />
                        ...
                        <Button type="submit" className="w-full" disabled={loading || loadingRooms}>
