...
const COMPUTER_PART_TYPES = ['SYSTEM_UNIT', 'MONITOR', 'UPS'];
      ...
      if (!response.ok) {
        ...
        throw new Error(
          responseData.error ||
            ...
            `Failed to ${isEditing ? 'update' : 'create'} storage item`
        );
      }

      toast.success(
        `Storage item ${isEditing ? 'updated' : 'created'} successfully!`
      );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {isEditing
            ? 'Update the storage item information'
            : 'Add an item to your inventory storage'}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  ...
                  {serialNumbersRequired && (
                    <FormDescription>
                      {subType} requires a serial number for each unit (
                      ...
                      <div className='flex flex-wrap gap-2'>
                        {serialNumbers.map((serial, index) => (
                          ...
                          >
                            ...
                            <button
                              type='button'
                              className='text-secondary-foreground hover:text-destructive ml-2'
