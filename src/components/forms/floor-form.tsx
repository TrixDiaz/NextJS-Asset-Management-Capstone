...
const floorSchema = z.object({
    number: z.coerce.number().int().positive({ message: 'Floor number must be a positive integer' }),
            ...
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <Button type="submit" className="w-full" disabled={loading || loadingBuildings}>
