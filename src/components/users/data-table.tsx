  ...
  const selectedRows = useMemo(() => {
    ...
    if (data.length > 0) {
      ...
      const selectedIds = Object.keys(rowSelection)
        .filter((index) =>
          Boolean(rowSelection[index as keyof typeof rowSelection])
        )
        .map((index) => {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className='flex items-center space-x-2'>
            <div className='bg-primary/10 dark:bg-primary/20 flex h-8 w-8 items-center justify-center rounded-full'>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Select a new role for the {Object.keys(rowSelection).length}{' '}
              selected users.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className='py-4'>
