            ...
            <CardContent>
              <dl className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                ...
                <div className='md:col-span-2'>
                  ...
                  <dd className='mt-1'>
                    {storageItem.remarks || 'No remarks'}
                  </dd>
                </div>
                <div>
                  <dt className='text-sm font-medium text-gray-500'>
                    ...
                    >
                      ...
                      {record.serialNumber && (
                        <div className='my-1 text-sm'>
                          Serial:{' '}
                          <Badge variant='outline'>{record.serialNumber}</Badge>
                        </div>
                      )}
...
export default async function StorageItemDetailPage({
  params
}: StorageItemDetailPageProps) {
