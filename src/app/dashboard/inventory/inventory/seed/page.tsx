    ...
    <div className='container p-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create sample data for buildings, floors, and rooms to use in the
            application
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className='flex flex-col items-center gap-4'>
            <p className='text-center'>
              ...
              This is useful for testing the application and deploying inventory
              items.
            </p>

            <Button onClick={handleSeed} disabled={loading} className='mt-4'>
