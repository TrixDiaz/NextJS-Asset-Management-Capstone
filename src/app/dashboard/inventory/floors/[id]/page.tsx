    ...
    <div className='container w-full p-6'>
      ...
      {floor.rooms.length === 0 ? (
        <div className='rounded-lg border p-12 text-center'>
          <h3 className='mb-2 text-lg font-medium'>No Rooms Added Yet</h3>
        ...
        <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
          {floor.rooms.map((room) => (
            <Link href={`/dashboard/inventory/rooms/${room.id}`} key={room.id}>
              <Card className='h-full cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-800'>
                <CardHeader>
