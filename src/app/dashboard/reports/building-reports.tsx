                    ...
                    <div id="room-type-chart" className="w-full max-w-2xl">
                        ...
                        <div className="flex justify-center mt-4">
                            <Button
                                variant="outline"
                                size="sm"
                                onClick={() => exportChartAsImage('room-type-chart', 'room-type-distribution')}
                            >
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Button
                        ...
                        size="sm"
                        className="ml-auto flex items-center gap-1"
                        onClick={() => exportToCsv(roomUtilization, 'room-utilization-data')}
                    >
                        <Download className="h-4 w-4" />
                        <span>Export Data</span>
                    </Button>
                    ...
                    <div id="room-utilization-chart" className="w-full max-w-3xl">
                        ...
                        <div className="flex justify-center mt-4">
                            <Button
                                variant="outline"
                                size="sm"
                                onClick={() => exportChartAsImage('room-utilization-chart', 'room-utilization-chart')}
                            >
                                <Download className="h-4 w-4 mr-2" />
                                Export Chart
                            </Button>
